...
function applySortFilter(array, comparator, query) {
  ...
  if (query) {
    ...
    // const userFilter = filter(array, (_user) => _user.phone.country_code.toLowerCase().indexOf(query.toLowerCase()) !== -1);
...
export default function UserListedGroup() {
                  ...
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">{phone.country_code}</TableCell>
